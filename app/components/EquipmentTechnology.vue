  ...
  <section class="section">
    <div class="construction">
      <div class="construction-wrapper">
        <div class="container">
          <div class="construction-wrapper-inner">
            <div class="construction-wrapper-inner-title">
            ...
            <img src="../assets/images/EquipmentTechnology.png" alt="" />
            <div class="construction-wrapper-inner-category">
              <div class="construction-wrapper-inner-category-card">
                <nuxt-link v-for="(k, index) in Category" :key="index">
                  <div class="construction-wrapper-inner-category-card-img">
                    <img :src="k.img" alt="" />
                  </div>
                  <div class="construction-wrapper-inner-category-card-title">
                    <p>{{ k.title }}</p>
                  </div>
                </nuxt-link>
              </div>
              <div class="construction-wrapper-inner-category-all">
                <nuxt-link>
                  <p>Все категории</p>
      ...
      <div class="container">
        <div class="construction-cards">
          ...
          <div class="construction-cards-all">
            <nuxt-link
...
import img from '../assets/images/EquipmentTechnology1.png'
