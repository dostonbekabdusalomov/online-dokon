<template>
  <section class="section">
    <div class="medical-products">
      <div class="medical-products-wrapper">
        <div class="container">
          <div class="medical-products-wrapper-inner">
            <div class="medical-products-wrapper-inner-title">
            ...
            <div class="medical-products-wrapper-inner-category">
              <div class="medical-products-wrapper-inner-category-card">
                <nuxt-link v-for="(k, index) in Category" :key="index">
                  <div class="medical-products-wrapper-inner-category-card-img">
                    <img :src="k.img" alt="" />
                  </div>
                  <div
                    class="medical-products-wrapper-inner-category-card-title"
                  >
                    <p>{{ k.title }}</p>
                  </div>
                </nuxt-link>
              </div>
              <div class="medical-products-wrapper-inner-category-all">
                <nuxt-link>
                  <p>Все категории</p>
      ...
      <div class="container">
        <div class="medical-products-cards">
          <div>
            <Card
          ...
          <div class="medical-products-cards-all">
            <nuxt-link
...
import img from '../assets/images/medical1.png'
